...
// @version      1.1.0
// @description  2021年7月15日更新 竖向横向布局随意切换，支持图形界面自定义设置分类和添加链接，个人配置自动保存到谷歌插件。
// @author       endday
// @license      GPL-2.0
// @update       2021/7/15
...
!function(e) {
    ...
    let g = m();
    const v = i("mode"), b = "vertical" !== (y = v) && "horizontal" !== y ? "horizontal" : y;
    var y;
    const w = (e = b) => {
        g = m();
    ...
    var Ke = P(L((function(e, n) {
        ...
        var r = t.defineComponent({
            ...
            setup(e) {
                ...
                return t.onMounted(() => {
                    Xe.on(a.value, "mousemove", v), Xe.on(a.value, "mouseleave", b);
                }), t.onBeforeUnmount(() => {
                    Xe.off(document, "mouseup", h), Xe.off(a.value, "mousemove", v), Xe.off(a.value, "mouseleave", b);
                }), {
                    instance: n,
                    thumb: r,
                    bar: s,
    ...
    var Lt = {
        ...
        phase: "main",
        fn: function(e) {
            var t, n = e.state, o = e.name, r = e.options, a = n.elements.arrow, i = n.modifiersData.popperOffsets, s = gt(n.placement), l = St(s), c = [ at, rt ].indexOf(s) >= 0 ? "height" : "width";
            if (a && i) {
                var u = function(e, t) {
                    return At("number" != typeof (e = "function" == typeof e ? e(Object.assign({}, t.rects, {
                        placement: t.placement
                    })) : e) ? e : Pt(e, it));
                }(r.padding, n), d = bt(a), p = "y" === l ? nt : at, f = "y" === l ? ot : rt, m = n.rects.reference[c] + n.rects.reference[l] - i[l] - n.rects.popper[c], h = i[l] - n.rects.reference[l], g = Et(a), v = g ? "y" === l ? g.clientHeight || 0 : g.clientWidth || 0 : 0, b = m / 2 - h / 2, y = u[p], w = v - d[c] - u[f], x = v / 2 - d[c] / 2 + b, _ = Nt(y, x, w), k = l;
    ...
    function jt(e) {
        ...
        }(a) : "function" == typeof c ? c(a) : a, d = u.x, p = void 0 === d ? 0 : d, f = u.y, m = void 0 === f ? 0 : f, h = a.hasOwnProperty("x"), g = a.hasOwnProperty("y"), v = at, b = nt, y = window;
        if (l) {
            var w = Et(n), x = "clientHeight", _ = "clientWidth";
            w === dt(n) && "static" !== wt(w = _t(n)).position && (x = "scrollHeight", _ = "scrollWidth"), 
            w = w, r === nt && (b = ot, m -= w[x] - o.height, m *= s ? 1 : -1), r === at && (v = rt, 
    ...
    function Ht(e) {
        return vt(_t(e)).left + qt(e).scrollLeft;
    }
    function Ut(e) {
    ...
    function Kt(e) {
        var t, n = e.reference, o = e.element, r = e.placement, a = r ? gt(r) : null, i = r ? Xt(r) : null, s = n.x + n.width / 2 - o.width / 2, l = n.y + n.height / 2 - o.height / 2;
        switch (a) {
          case nt:
            t = {
                x: s,
    ...
    var en = {
        ...
        fn: function(e) {
            ...
            if (!t.modifiersData[o]._skip) {
                for (var r = n.mainAxis, a = void 0 === r || r, i = n.altAxis, s = void 0 === i || i, l = n.fallbackPlacements, c = n.padding, u = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.flipVariations, m = void 0 === f || f, h = n.allowedAutoPlacements, g = t.options.placement, v = gt(g), b = l || (v === g || !m ? [ Ft(g) ] : function(e) {
                    if ("auto" === gt(e)) return [];
                    var t = Ft(e);
                    return [ Zt(e), t, Zt(t) ];
                }(g)), y = [ g ].concat(b).reduce((function(e, n) {
                    return e.concat("auto" === gt(n) ? Qt(t, {
                        placement: n,
                        boundary: u,
                        rootBoundary: d,
                        padding: c,
                    ...
                    var S = y[E], C = gt(S), M = "start" === Xt(S), T = [ nt, ot ].indexOf(C) >= 0, N = T ? "width" : "height", A = Jt(t, {
                        placement: S,
                        boundary: u,
                        rootBoundary: d,
                        altBoundary: p,
        ...
        fn: function(e) {
            var t = e.state, n = e.options, o = e.name, r = n.offset, a = void 0 === r ? [ 0, 0 ] : r, i = lt.reduce((function(e, n) {
                return e[n] = function(e, t, n) {
                    var o = gt(e), r = [ at, nt ].indexOf(o) >= 0 ? -1 : 1, a = "function" == typeof n ? n(Object.assign({}, t, {
                        placement: e
                    })) : n, i = a[0], s = a[1];
    ...
    var sn = {
        ...
        phase: "main",
        fn: function(e) {
            var t = e.state, n = e.options, o = e.name, r = n.mainAxis, a = void 0 === r || r, i = n.altAxis, s = void 0 !== i && i, l = n.boundary, c = n.rootBoundary, u = n.altBoundary, d = n.padding, p = n.tether, f = void 0 === p || p, m = n.tetherOffset, h = void 0 === m ? 0 : m, g = Jt(t, {
                boundary: l,
                rootBoundary: c,
                padding: d,
                altBoundary: u
            }), v = gt(t.placement), b = Xt(t.placement), y = !b, w = St(v), x = "x" === w ? "y" : "x", _ = t.modifiersData.popperOffsets, k = t.rects.reference, O = t.rects.popper, E = "function" == typeof h ? h(Object.assign({}, t.rects, {
                placement: t.placement
            })) : h, S = {
                x: 0,
                y: 0
            ...
            if (_) {
                if (a || s) {
                    var C = "y" === w ? nt : at, M = "y" === w ? ot : rt, T = "y" === w ? "height" : "width", N = _[w], A = _[w] + g[C], P = _[w] - g[M], L = f ? -O[T] / 2 : 0, B = "start" === b ? k[T] : O[T], j = "start" === b ? -O[T] : -k[T], D = t.elements.arrow, z = f && D ? bt(D) : {
                        width: 0,
                        height: 0
                    ...
                    if (s) {
                        var X = "x" === w ? nt : at, K = "x" === w ? ot : rt, J = _[x], Q = J + g[X], ee = J - g[K], te = Nt(f ? Mt(Q, $) : Q, J, f ? Ct(ee, G) : ee);
                        _[x] = te, S[x] = te - J;
                    }
                }
                t.modifiersData[o] = S;
    ...
    function ln(e, t, n) {
        void 0 === n && (n = !1);
        var o, r, a = _t(t), i = vt(e), s = ft(t), l = {
            scrollLeft: 0,
            scrollTop: 0
        }, c = {
            x: 0,
        ...
        } : qt(o)), ft(t) ? ((c = vt(t)).x += t.clientLeft, c.y += t.clientTop) : a && (c.x = Ht(a))), 
        {
    ...
    var yn = L((function(e, t) {
        ...
        Object.defineProperty(u, "zIndex", {
            configurable: !0,
            get: () => (void 0 === i && (i = vn.getConfig("zIndex") || 2e3), i),
            set(e) {
                i = e;
            }
        });
   ...
   */;
    ...
    var $n = L((function(e, n) {
        ...
        function v(e, {emit: n}) {
            ...
            const p = () => e.manualMode || "manual" === e.trigger, f = t.ref({
                ...
                get: () => !e.disabled && (Ye.isBool(e.visible) ? e.visible : g.visible),
                set(t) {
                    p() || (Ye.isBool(e.visible) ? n("update:visible", t) : g.visible = t);
                }
            });
            function b() {
            ...
            function O() {
                ...
                l = gn.createPopper(t, Ye.$(i), Ye.$(m)), l.update();
            }
            function E(e) {
                !l || Ye.$(v) && !e || S();
            }
        ...
        const b = () => {};
        function y(e, n) {
            const {effect: o, name: r, stopPopperMouseEvent: a, popperClass: i, popperStyle: s, popperRef: l, pure: c, popperId: u, visibility: d, onMouseenter: p, onMouseleave: f, onAfterEnter: m, onAfterLeave: h, onBeforeEnter: g, onBeforeLeave: v} = e, y = [ i, "el-popper", "is-" + o, c ? "is-pure" : "" ], w = a ? Xe.stop : b;
    ...
    ho.render = function(t, n, o, r, a, i) {
        ...
        }, null, 8, [ "value" ]), [ [ e.vModelRadio, r.model ] ]), vo, e.createVNode("span", bo, [ e.renderSlot(t.$slots, "default") ]) ]);
